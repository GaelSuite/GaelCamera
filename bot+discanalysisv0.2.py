...
lower_yellow = np.array([23.6547761, 86.53954546, 183.41877841])
upper_yellow = np.array([35.38256501, 190.16993547, 255])
...
def segment_color_objects(frame, lower, upper, field_mask):
    ...
    _, sure_fg = cv2.threshold(dist_transform, dist_transform.max(), 255, 0)

    # Identify the background and unknown region
